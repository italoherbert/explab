...
public class UnsPreencheMatrizFunc extends AbstractFuncAdapter {

    private final String NOME = FuncFactory.UNS;
    ...
    public FuncResult exec( Codigo codigo, MetodoParam[] params, int i ) {
        ...
        MetodoParam valorMP = new MetodoParam( new NumeroRealVar( 1 ) );
