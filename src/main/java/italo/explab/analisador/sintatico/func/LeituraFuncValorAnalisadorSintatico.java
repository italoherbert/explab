...
public class LeituraFuncValorAnalisadorSintatico implements AnalisadorSintatico {

    private final AnalisadorSintaticoManager manager;

    public LeituraFuncValorAnalisadorSintatico( AnalisadorSintaticoManager manager ) {
